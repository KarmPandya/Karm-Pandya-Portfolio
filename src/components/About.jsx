  ...
  return (
    <div id="about" className=" bg-[#ffffff] text-[#1e293b] pt-16 sm:pt-20 lg:pt-30 pb-8 sm:pb-10 px-4">
      <div className="w-full max-w-5xl mx-auto">
        <p className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-6 lg:mb-8 text-left">About Me</p>

        <p className="text-[#243147] text-base sm:text-lg lg:text-xl leading-relaxed mb-6 text-left">
