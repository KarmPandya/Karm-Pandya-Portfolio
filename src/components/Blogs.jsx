        ...
        <div id="blogs" className=" bg-[#ffffff] text-white py-12 sm:py-15 lg:py-20 pb-20 sm:pb-30 flex flex-col px-4">
            <div className="w-full max-w-6xl mx-auto">
                <div className="text-center mb-8 lg:mb-12">
                    ...
                    <p className="text-[#64748b] text-sm sm:text-base lg:text-lg max-w-2xl mx-auto">Thoughts and insights on development and technology</p>
                </div>

                <div className="flex flex-col gap-8 sm:gap-10">
                    {/* Blog 1 */}
                    <div className="flex flex-col lg:flex-row justify-between items-center p-4 sm:p-6 bg-[#eeeeee] rounded-xl gap-4 sm:gap-6">
                        <div className="text-[#1e293b] flex-1 text-center lg:text-left">
                            ...
                            <button
                                onClick={openblog1}
                                target="_blank"
                                className="text-white bg-blue-700 my-2 py-2 px-3 rounded-xl hover:bg-blue-600 cursor-pointer transition text-sm sm:text-base"
                            >
                                Read Blog
                            </button>
                        </div>
