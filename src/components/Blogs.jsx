...
const Blogs = () => {
    ...
    return (
        <div id="blogs" className=" bg-gray-900 text-white py-12 sm:py-15 lg:py-20 pb-20 sm:pb-30 flex flex-col px-4">
            <div className="w-full max-w-5xl mx-auto">
                <div className="text-left mb-8 lg:mb-12">
                    <p className="text-white text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">Blogs</p>
                    <p className="text-gray-300 text-sm sm:text-base lg:text-lg max-w-2xl">Thoughts and insights on development and technology</p>
                </div>

                <div className="flex flex-col gap-8 sm:gap-10">
                    {/* Blog 1 */}
                    <div className="bg-gray-800 rounded-xl px-4 py-4 sm:p-6 flex flex-col">
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-2 sm:gap-6 mb-4 lg:mb-0">
                            <div className="text-white flex-1 text-left order-2 lg:order-1">
                                <p className="mb-2 font-bold text-sm sm:text-base text-gray-300">Blog On React</p>
                                <p className="my-4 sm:my-6 text-lg sm:text-xl lg:text-2xl text-white">
                    ...
                    {/* Blog 2 */}
                    <div className="bg-gray-800 rounded-xl p-4 sm:p-6 flex flex-col">
                        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 sm:gap-6 mb-4 lg:mb-0">
                            <div className="text-white flex-1 text-left order-2 lg:order-1">
                                <p className="mb-2 font-bold text-sm sm:text-base text-gray-300">Blog On S.O.L.I.D. Principles</p>
                                <p className="my-4 sm:my-6 text-lg sm:text-xl lg:text-2xl text-white">
